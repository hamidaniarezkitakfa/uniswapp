...
//fonction de connexion messagerie
// const userLogin = (e) => {
...
// }
//fonction d'inscription pour la messagerie
// const registerUser = (e) =>{
    
//   e.preventDefault();

//   const user = {
//     nom:nom,prenom:prenom,email: email , password:password,confirmPassword:confirmPassword,formation:formation
//   }
   
//      dispatch(signup(user))
// }
// if (auth.authenticated){
//   return window.alert ("inscription reussite  ");
    ...
    return (
      ...
      <div class={DivContainer}>
        <div class="signin-signup">
          ...
          <form action="" onClick= {  handleLogin } class="sign-in-form">
